...
from PIL.ImageFilter import (BLUR, CONTOUR, DETAIL, EDGE_ENHANCE, EDGE_ENHANCE_MORE, EMBOSS, FIND_EDGES, SMOOTH_MORE, SHARPEN, GaussianBlur, UnsharpMask)
...
lb_image = QLabel ("тут должна быть картина")#
btn_dir = QPushButton("мапка")
